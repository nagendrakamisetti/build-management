...
<%
    ...
    URL formApproveUrl = new URL(appUrl + "/patch/CMnSubmitApproval");
...
<tr>
  ...
  <td bgcolor="#CCCCCC" colspan="2" align="center">Action</td>
</tr>
...
<%
        ...
        while (patchList.hasMoreElements()) {
            ...
            String urlApprove = formApproveUrl.toString() + "?" + pidAttr + "&" + IMnPatchForm.APPROVAL_STATUS + "=" + CMnPatchApprovalForm.PATCH_APPROVED_VALUE;
            String urlReject = formApproveUrl.toString() + "?" + pidAttr + "&" + IMnPatchForm.APPROVAL_STATUS + "=" + CMnPatchApprovalForm.PATCH_REJECTED_VALUE; 
%>
  <tr>
    <td><%= strCust %></td>
    <td><%= strEnv %></td>
    ...
    <td bgcolor="#7CFC00">&nbsp;[ <a href="<%= urlApprove %>">Approve</a> ]&nbsp;</td>
    <td bgcolor="#FF6347">&nbsp;[ <a href="<%= urlReject %>">Reject</a> ]&nbsp;</td>
  </tr>
