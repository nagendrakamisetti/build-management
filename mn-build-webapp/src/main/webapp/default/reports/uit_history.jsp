...
<%
    ...
    // Construct UitHistoryView	
    //URL viewHistoryUrl = new URL(appUrl + "/report/CMnUitHistory?uitId="+uit.getId());
    Vector testList = (Vector) request.getAttribute(IMnTestForm.HISTORY_OBJECT_LABEL);
    CMnUitHistoryView uitHistoryView = new CMnUitHistoryView(formUitUrl, testList);
%>
...
<%= uitSuiteInfoForm.getTitledBorder(uitSuiteInfoForm.toString()) %>
  ...
  <!--                           UIT Information                      -->
  <!-- ==================================================================== -->
<%= uitInfoForm.getTitledBorder(uitInfoForm.toString()) %>
  <p>
