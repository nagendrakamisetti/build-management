...
/**
 * This command deletes the entire fix group. 
 * 
 * @author             Shawn Stafford
 */
public class CMnFixGroupDelete extends AdminCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                // Delete the fix group 
                String groupId = (String) req.getParameter(IMnPatchForm.GROUP_ID_LABEL);
                if ((groupId != null) && (groupId.trim().length() > 0)) {
                    boolean success = patchTable.deleteFixGroup(rc.getConnection(), groupId);
                }
