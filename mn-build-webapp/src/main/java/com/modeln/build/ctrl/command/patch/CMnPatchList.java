 ...
 */
public class CMnPatchList extends CMnBasePatchRequest {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                CMnPatchListForm form = new CMnPatchListForm(new URL("http://localhost/CMnBuildList"), new URL("http://localhost/images"), new Vector());
                form.setValues(req);
                ...
                Vector patches = patchTable.getAllRequests(rc.getConnection(), form.getValues(), form.getMaxRows(), true);
                int patchCount = 0;
                ...
                result.setDestination("patch/patch_list.jsp");
