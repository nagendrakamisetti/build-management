 ...
 */
public class CMnRequestQueue extends CMnBasePatchRequest {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                result.setDestination("patch/patch_mylist.jsp");
