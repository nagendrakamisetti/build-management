 ...
 */
public class CMnFlexTestHistory extends TrustedHostCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                Vector tests = flexTable.getTestHistory(rc.getConnection(), testData);
                ...
                result.setDestination("reports/flextest_history.jsp");
