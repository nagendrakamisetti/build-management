 ...
 */
public class CMnTestHistory extends TrustedHostCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                CMnDbUnitTestData testData = utTable.getTest(rc.getConnection(), testId); 
                ...
                if (testData.getStartTime() != null) {
                    CMnDbUnitTestData lastFail = utTable.getLastFailure(rc.getConnection(), testData);
                    req.setAttribute(IMnTestForm.LASTFAIL_OBJECT_LABEL, lastFail);

                    CMnDbUnitTestData lastPass = utTable.getLastPass(rc.getConnection(), testData);
                    req.setAttribute(IMnTestForm.LASTPASS_OBJECT_LABEL, lastPass);
                }

                // Obtain the historical test results 
                Vector tests = utTable.getTestHistory(rc.getConnection(), testData);
                ...
                CMnDbTestSuite suiteData = utTable.getSuite(rc.getConnection(), suiteId);
                if (suiteData != null) {
                ...
                result.setDestination("reports/unittest_history.jsp");
