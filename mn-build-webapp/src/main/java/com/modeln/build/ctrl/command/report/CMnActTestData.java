 ...
 */
public class CMnActTestData extends TrustedHostCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                if (testData != null) {
                    Vector testcases = actTable.getTestCases(rc.getConnection(), testId);
                    if ((testcases != null) && (testcases.size() > 0)) {
                        testData.setTestCases(testcases);
                    }
                    Vector stories = actTable.getStories(rc.getConnection(), testId);
                    if ((stories != null) && (stories.size() > 0)) {
                        testData.setStories(stories);
                    }
                }
                ...
                result.setDestination("reports/act.jsp");
