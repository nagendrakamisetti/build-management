...
/**
 * The suite form provides an HTML interface to the ACT suite objects.
 ...
 */
public class CMnActSuiteForm extends CMnBaseSuiteForm {

    /** Default title displayed in the bordered header */
    private static final String DEFAULT_TITLE = "ACT Test Results";


    /**
     * Construct the form from a list of ACT test suites.  The form will
     ...
     */
    public CMnActSuiteForm(URL form, URL images, Vector suites) {
    ...
    protected void initGroups() {
        ...
        CMnDbTestSuite defaultPrototype = new CMnDbTestSuite(CMnDbTestSuite.SuiteType.ACT);
        ...
        CMnDbTestSuite populatePrototype = new CMnDbTestSuite(CMnDbTestSuite.SuiteType.ACT);
        ...
        CMnDbTestSuite testPrototype = new CMnDbTestSuite(CMnDbTestSuite.SuiteType.ACT);
        ...
        CMnDbTestSuite bugPrototype = new CMnDbTestSuite(CMnDbTestSuite.SuiteType.ACT);
