...
/**
 * This command allows a user to delete a service patch request. 
 * 
 * @author             Shawn Stafford
 */
public class CMnPatchDelete extends AdminCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                app.debug("CMnPatchDelete: obtained a connection to the build database");
                ...
                // Delete the service patch record from the database after all
                // other commands have been completed, otherwise the commands
                // may not have access to the patch data 
                patchTable.deleteRequest(rc.getConnection(), patchId);

                // Forward the user to the next step in the request process
                result = app.forwardToCommand(req, res, "/patch/CMnPatchList");
