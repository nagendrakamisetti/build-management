...
/**
 * This command displays a list of all build deployments. 
 * 
 * @author             Shawn Stafford
 */
public class CMnDeploymentList extends TrustedHostCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                CMnProgressTable dbTable = new CMnProgressTable();
                Vector list = dbTable.getLatestProgressByHost(rc.getConnection(), "hdqpdqaapp1.modeln.com");
                result.setDestination("environment/deployment_list.jsp");
