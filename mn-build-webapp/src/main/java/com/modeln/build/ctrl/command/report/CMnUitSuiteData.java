 ...
 */
public class CMnUitSuiteData extends TrustedHostCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                Vector testList = uitTable.getTestsBySuite(rc.getConnection(), suiteId);
                req.setAttribute(IMnTestForm.SUITE_OBJECT_LABEL, suiteData);
                req.setAttribute("UIT_LIST", testList);
                ...
                result.setDestination("reports/uit_suite.jsp");
