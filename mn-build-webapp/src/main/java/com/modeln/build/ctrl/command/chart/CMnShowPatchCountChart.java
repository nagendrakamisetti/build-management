 ...
 * of patch requests per customer. 
 * 
 * @author             Shawn Stafford
 */
public class CMnShowPatchCountChart extends ChartCommand {
        ...
        throws ApplicationException
    {
        ...
        if (!result.containsError()) {
            ...
            try {
                ...
                Hashtable<CMnAccount, Integer> customers = reportTable.getCustomerPatchCount(rc.getConnection(), start, end); 

                if ((format != null) && format.equalsIgnoreCase(CMnChartForm.FORMAT_CSV)) {
                    streamAccountSpreadsheet(app, req, res, customers); 
                } else {
                    JFreeChart chart = CMnPatchCountChart.getPatchesByCustomerChart(customers, "Patch Requests");
