...
public class UITestStepTest extends AbstractEntityTest {
...
//		uiTest.setGroupName("groupName");
		...
		uiTestStep = em.find(UITestStep.class, uiTestStep.getId());
		...
		Query queryFindAllUITestSteps = em.createQuery("SELECT u FROM UITestStep u");
		List<UITestStep> uiTestSteps = queryFindAllUITestSteps.getResultList();
		assertTrue(uiTestSteps.isEmpty());
