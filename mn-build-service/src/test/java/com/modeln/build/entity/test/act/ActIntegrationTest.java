...
public class ActIntegrationTest extends AbstractEntityIntegrationTest {
	...
	public void testSimpleCRUDOperationOnLegacyTable() throws Exception {		
		...
		act = em_bc.find(Act.class, act.getId());
		assertTrue(act.getAuthor().equals("author"));
		assertTrue(act.getFilename().equals("filename"));
		assertTrue(act.getGroupName().equals("groupName"));
		assertTrue(act.getMessage().equals("message"));
		assertTrue(act.getStatus().equals(com.modeln.build.enums.test.Status.PASS));
		assertTrue(act.getSuite().getId() == actSuite.getId());
		assertTrue(act.getSummary().equals("summary"));
		assertTrue(act.getStartDate() != null);
		assertTrue(act.getEndDate() != null);
		
		//Update Entity	
		act.setFilename("updateFilename");
		tx_bc.begin();
		em_bc.persist(act);	
		tx_bc.commit();
		...
		act = em_bc.find(Act.class, act.getId());
		assertTrue(act.getAuthor().equals("author"));
		assertTrue(act.getFilename().equals("updateFilename"));
		assertTrue(act.getGroupName().equals("groupName"));
		assertTrue(act.getMessage().equals("message"));
		assertTrue(act.getStatus().equals(com.modeln.build.enums.test.Status.PASS));
		assertTrue(act.getSuite().getId() == actSuite.getId());
