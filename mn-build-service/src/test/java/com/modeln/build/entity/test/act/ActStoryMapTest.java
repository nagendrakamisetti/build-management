...
public class ActStoryMapTest extends AbstractEntityTest {
	...
	public void testSimpleCRUDOperations() throws Exception {
		...
		actStoryMap = em.find(ActStoryMap.class, new ActStoryMapId(act.getId(), actStoryMap.getStory()));
		...
		Query queryFindAllActStoryMaps = em.createQuery("SELECT u FROM ActStoryMap u");
		List<Act> actStoryMaps = queryFindAllActStoryMaps.getResultList();
		assertTrue(actStoryMaps.isEmpty());
