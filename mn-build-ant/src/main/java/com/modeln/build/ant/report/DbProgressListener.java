...
public class DbProgressListener implements BuildListener {
    ...
    private Vector<ProgressTarget> progressTargets;
     ...
     */
    public DbProgressListener(Connection conn, String build, Vector<ProgressTarget> list, CMnProgressTable table) 
    ...
    public ProgressTarget getProgressIndicator(Target target) {
        ...
        Enumeration<ProgressTarget> list = progressTargets.elements();
